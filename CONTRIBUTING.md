...
- **Content:** If you want to add new content (such as Origins or Win Conditions), copy and modify the Example Addon mod instead. If you need something to be added to Playwright's addon API to properly create your content, feel free to either ask, or open a PR with what you need.
