...
namespace Rokk.Playwright.Compat.VREAndroids.Components.Boons
{
    public class AndroidsBoon : BoonComponent
    {
        ...
        public bool StartWithResearch = true;
        ...
        protected override void DoSettingsContents(Listing_AutoFitVertical boonContentListing, OriginComponent origin)
        {
            ...
            boonContentListing.IntEntry(ref Amount, ref AmountBuffer, 1, 0);
            boonContentListing.CheckboxLabeled("Playwright.Components.Boons.Compat_VREAndroids_Androids.StartWithAndroidResearch".Translate(), ref StartWithResearch, "Playwright.Components.Boons.Compat_VREAndroids_Androids.StartWithAndroidResearch.Help".Translate());
        }
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look(ref StartWithResearch, nameof(StartWithResearch), true);
