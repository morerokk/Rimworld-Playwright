...
{
    public class NoColonistRerolls : ScenPart
    {
        public override void DoEditInterface(Listing_ScenEdit listing)
        {
            ...
            {
                Find.WindowStack.Add(new InfoPopupWindow("Playwright.ScenParts.NoColonistRerolls.Help".Translate()));
            }
        }
        ...
        {
            return "Playwright.ScenParts.NoColonistRerolls.Summary".Translate();
        }
    }
}
